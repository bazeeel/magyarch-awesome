...
theme.wallpaper                                 = os.getenv("HOME") .. "/.config/awesome/themes/magyarch-dark/wallpaper.png"
...
theme.tasklist_fg_focus                         = "#121212"
...
local barcolor  = gears.color({
    ...
    from  = { dpi(32), 0 },
    to    = { dpi(32), dpi(32) },
    stops = { {0, theme.bg_focus}, {0.25, "#121212"}, {1, theme.bg_focus} }
})
